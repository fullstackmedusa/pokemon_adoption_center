...
2. Clone the `passport-code-along` repo:  `git clone https://git.generalassemb.ly/SEI-CC/passport-code-along.git`

3. `cd passport-code-along`
...
- **routes/students.js** has one routes defined for the following actions:
